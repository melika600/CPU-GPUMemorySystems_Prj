...
> **GitHub:** This file is what you see formatted here. The knit-able R Markdown source with the same narrative is [`sigma_delta_flow.Rmd`](sigma_delta_flow.Rmd) — GitHub only shows `.Rmd` as raw text, not a preview like this file.
...
## 9. Rendering the R Markdown source
