...
if args.dataset == 'cifar10':
    # Avoid DataLoader worker hangs in some environments (conda/CUDA + fork/spawn quirks).
    train_loader, test_loader = dataset.get_cifar10(batch_size=args.batch_size, num_workers=0)
elif args.dataset == 'cifar100':
    train_loader, test_loader = dataset.get_cifar100(batch_size=args.batch_size, num_workers=0)
elif args.dataset == 'imagenet':
    train_loader, test_loader = dataset.get_imagenet(batch_size=args.batch_size, num_workers=0)
else:
